...
from scripts.relace.model_configs import tinydense_500K
...
def build_config(opts, overrides: List[str]) -> ExperimentConfig:
    ...
    train_module_config = TransformerTrainModuleConfig(
        rank_microbatch_size=256 * 1024,  # NOTE: this is specified in tokens, not instances
